...
router.get('/classes/students/all', verifyToken, authorize('admin'), adminController.getStudentsForModal); //
router.get('/classes/teachers/all', verifyToken, authorize('admin'), adminController.getTeachersForModal);
...
router.get('/projects/students/all', verifyToken, authorize('admin'), adminController.getStudentsForModal);
router.get('/projects/teachers/all', verifyToken, authorize('admin'), adminController.getTeachersForModal);
